        ...
        <div className={styles.artist}>
          ...
          <div className={styles.artistDescription}>
            ...
            <div>
              ...
              83/6 [2023]), and “Mirror, mirror on the wall, who's the most
          ...
          <div className={styles.artistDescription}>
            ...
            <div>
              ...
              Viva sponsored masterclass. He's a scholarship holder of the Music
            ...
            <div>
              ...
              “International Competition for Young Pianists 'Steps to Mastery'”
              in St Petersburg in 2017, the 2nd prize and a string of awards
              (Concerto Prize, Queensland Symphony Orchestra Vote Prize and
              Audience Prize) at the “Lev Vlassenko Piano Competition” as its
              youngest participant in Australia in 2017, the 3rd prize in the
              “Val de Travers International Piano Competition” in Switzerland in
              2018 and the 1stprize in the “Ananda Sukarlan Award International
              Piano Competition” in Jakarta in 2020. As the winner of the 2021
              “SCM Piano Concerto Competition”, Calvin performed Prokofiev’s
              Piano Concerto No. 3 in May 2022 with the Sydney Conservatorium
              Symphony Orchestra. In the same year, he was the recipient of the
              “Frank Albert Prize for Music” at the Sydney Conservatorium.
            </div>
            <div>
              ...
              Terracini. In 2022, he performed Prokofiev's Piano Concerto No. 4
              as the soloist in the inaugural concert of the G20 Orchestra at
              the Candi Borobudur (UNESCO World Heritage Site), which was
            ...
            <div>
              ...
              and Switzerland. He's an avid chamber musician and has performed
              in the Canberra International Music Festival in 2021 and the Out
              West Piano Festival in 2023. He was the founding member and former
              conductor of the youth orchestra Cantate Deo Chamber Orchestra
              from 2020 to 2023.
            </div>
            <div>
            ...
            <div>
              ...
              supported by the SCM Henderson Scholarships, Sydney Eisteddfod
              Kawai Piano Scholarship, Theme and Variation Foundation, Institut
              Francais d'Indonesie (IFI), Australian Elizabethan Theatre Trust,
              and the International Piano Foundation “Theo Lieven”. He was
              invited as scholarship holder to attend the Lieven Piano Summer
              School in 2022 and 2023, where he worked with the pianists Andreas
              Steier, Lilya Zilberstein, Paul Roberts, Davide Cabassi, Arie
              Vardi, Alexei Volodin, Alon Goldstein, and Robert Mcdonald. In
              2023, a scholarship from IFI enabled him to study the piano works
              of Ravel with Pascal Roge in Nice, France.
            </div>
            <Image
              width={1080}
              height={720}
